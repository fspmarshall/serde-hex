...
pub fn writehex<S,B,D>(src: S, mut dst: D) -> Result<(),Error> where S: IntoIterator<Item=B>, B: Borrow<u8>, D: io::Write { 
...
pub fn writehexcaps<S,B,D>(src: S, mut dst: D) -> Result<(),Error> where S: IntoIterator<Item=B>, B: Borrow<u8>, D: io::Write { 
    for byte in src.into_iter() {
